...
class Ui_FocusInterface(object):
    ...
    def retranslateUi(self, FocusInterface):
        ...
        self.taskLabel1.setText(_translate("FocusInterface", "完成期末作业"))
        self.taskLabel2.setText(_translate("FocusInterface", "上传代码"))
        self.taskLabel3.setText(_translate("FocusInterface", "休闲娱乐"))
